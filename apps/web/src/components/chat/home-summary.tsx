 ...
 *
 * One row up to the tablet, a tall tile on a wide screen. Funding balances are
...
export const BalanceTile = ({
  ...
  return (
    <Link
      ...
      className={cn(
        "tile tile--pear focus-visible:ring-ring/50 short:p-3 flex items-center justify-between gap-3 p-4 outline-none focus-visible:ring-3 sm:p-5 lg:flex-col lg:items-stretch lg:gap-5",
        className
      )}
      to="/wallet"
    >
      ...
      <span className="short:text-lg lg:text-money shrink-0 text-2xl font-semibold tracking-tight tabular-nums">
        {amount}
      </span>
